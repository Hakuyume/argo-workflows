...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.create_cluster_workflow_template(
            body=body,
        )
        pprint(api_response)
...
------------- | ------------- | -------------
[**IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateCreateRequest**](IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateCreateRequest.md) |  | 
...
> {str: (bool, date, datetime, dict, float, int, list, str, none_type)} delete_cluster_workflow_template(name)
...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.delete_cluster_workflow_template(
...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_cluster_workflow_template(
            path_params=path_params,
            query_params=query_params,
        )
        pprint(api_response)
...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.lint_cluster_workflow_template(
            body=body,
        )
        pprint(api_response)
    except argo_workflows.ApiException as e:
...
Type | Description  | Notes
------------- | ------------- | -------------
[**IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateLintRequest**](IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateLintRequest.md) |  | 
...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.list_cluster_workflow_templates(
            query_params=query_params,
        )
        pprint(api_response)
    except argo_workflows.ApiException as e:
...
> IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate update_cluster_workflow_template(namebody)
...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.update_cluster_workflow_template(
            path_params=path_params,
            body=body,
        )
        pprint(api_response)
...
Type | Description  | Notes
------------- | ------------- | -------------
[**IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateUpdateRequest**](IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateUpdateRequest.md) |  | 
