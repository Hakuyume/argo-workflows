...
**env** | **[EnvVar]** | List of environment variables to set in the container. Cannot be updated. | [optional] 
...
**imagePullPolicy** | **str** | Image pull policy. One of Always, Never, IfNotPresent. Defaults to Always if :latest tag is specified, or IfNotPresent otherwise. Cannot be updated. More info: https://kubernetes.io/docs/concepts/containers/images#updating-images | [optional] 
...
**volumeDevices** | **[VolumeDevice]** | volumeDevices is the list of block devices to be used by the container. | [optional] 
**volumeMounts** | **[VolumeMount]** | Pod volumes to mount into the container&#x27;s filesystem. Cannot be updated. | [optional] 
