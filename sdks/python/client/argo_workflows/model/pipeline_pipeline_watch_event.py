...
class PipelinePipelineWatchEvent(
    ...
    @classmethod
    @property
    def object(cls) -> typing.Type['GithubComArgoprojLabsArgoDataflowApiV1alpha1Pipeline']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        object: typing.Union['GithubComArgoprojLabsArgoDataflowApiV1alpha1Pipeline', Unset] = unset,
