...
class IoArgoprojEventsV1alpha1GitlabEventSource(
    ...
    enableSSLVerification = BoolSchema
    ...
    @classmethod
    @property
    def secretToken(cls) -> typing.Type['SecretKeySelector']:
        return SecretKeySelector
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        enableSSLVerification: typing.Union[enableSSLVerification, Unset] = unset,
        events: typing.Union[events, Unset] = unset,
        filter: typing.Union['IoArgoprojEventsV1alpha1EventSourceFilter', Unset] = unset,
        gitlabBaseURL: typing.Union[gitlabBaseURL, Unset] = unset,
        metadata: typing.Union[metadata, Unset] = unset,
        projectID: typing.Union[projectID, Unset] = unset,
        projects: typing.Union[projects, Unset] = unset,
        secretToken: typing.Union['SecretKeySelector', Unset] = unset,
