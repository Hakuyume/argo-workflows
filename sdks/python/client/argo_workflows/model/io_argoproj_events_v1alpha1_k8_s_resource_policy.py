...
class IoArgoprojEventsV1alpha1K8SResourcePolicy(
    ...
    @classmethod
    @property
    def backoff(cls) -> typing.Type['IoArgoprojEventsV1alpha1Backoff']:
        return IoArgoprojEventsV1alpha1Backoff
    errorOnBackoffTimeout = BoolSchema
    ...
    def __new__(
        cls,
        *args: typing.Union[dict, frozendict, ],
        backoff: typing.Union['IoArgoprojEventsV1alpha1Backoff', Unset] = unset,
        errorOnBackoffTimeout: typing.Union[errorOnBackoffTimeout, Unset] = unset,
        ...
        **kwargs: typing.Type[Schema],
        ...
        return super().__new__(
            ...
            *args,
            backoff=backoff,
            errorOnBackoffTimeout=errorOnBackoffTimeout,
            labels=labels,
            _configuration=_configuration,
            **kwargs,
        )
