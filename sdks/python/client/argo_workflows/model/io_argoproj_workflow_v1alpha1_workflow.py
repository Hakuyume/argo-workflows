...
class IoArgoprojWorkflowV1alpha1Workflow(
    ...
    @classmethod
    @property
    def spec(cls) -> typing.Type['IoArgoprojWorkflowV1alpha1WorkflowSpec']:
        return IoArgoprojWorkflowV1alpha1WorkflowSpec

    @classmethod
    @property
    def status(cls) -> typing.Type['IoArgoprojWorkflowV1alpha1WorkflowStatus']:
        return IoArgoprojWorkflowV1alpha1WorkflowStatus
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        status: typing.Union['IoArgoprojWorkflowV1alpha1WorkflowStatus', Unset] = unset,
