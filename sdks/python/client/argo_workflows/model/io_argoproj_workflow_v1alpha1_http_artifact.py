...
class IoArgoprojWorkflowV1alpha1HTTPArtifact(
    ...
    @classmethod
    @property
    def auth(cls) -> typing.Type['IoArgoprojWorkflowV1alpha1HTTPAuth']:
        return IoArgoprojWorkflowV1alpha1HTTPAuth
    ...
    class headers(
        ...
        @classmethod
        @property
        def _items(cls) -> typing.Type['IoArgoprojWorkflowV1alpha1Header']:
            return IoArgoprojWorkflowV1alpha1Header
    url = StrSchema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        url: url,
        auth: typing.Union['IoArgoprojWorkflowV1alpha1HTTPAuth', Unset] = unset,
