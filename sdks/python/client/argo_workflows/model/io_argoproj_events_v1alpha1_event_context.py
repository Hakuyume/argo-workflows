...
class IoArgoprojEventsV1alpha1EventContext(
    ...
    """
    datacontenttype = StrSchema
    id = StrSchema
    source = StrSchema
    specversion = StrSchema
    subject = StrSchema
    time = DateTimeSchema
    type = StrSchema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        datacontenttype: typing.Union[datacontenttype, Unset] = unset,
        id: typing.Union[id, Unset] = unset,
        source: typing.Union[source, Unset] = unset,
        specversion: typing.Union[specversion, Unset] = unset,
