...
class GithubComArgoprojLabsArgoDataflowApiV1alpha1PipelineSpec(
    ...
    @classmethod
    @property
    def deletionDelay(cls) -> typing.Type['Duration']:
        return Duration
    ...
    class steps(
        ...
        @classmethod
        @property
        def _items(cls) -> typing.Type['GithubComArgoprojLabsArgoDataflowApiV1alpha1StepSpec']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        deletionDelay: typing.Union['Duration', Unset] = unset,
