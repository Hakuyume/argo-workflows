...
_path = '/api/v1/stream/event-sources/{namespace}'
_method = 'GET'
_auth = [
    'BearerToken',
]
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    @classmethod
    @property
    def result(cls) -> typing.Type['EventsourceEventSourceWatchEvent']:
        return EventsourceEventSourceWatchEvent
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        result: typing.Union['EventsourceEventSourceWatchEvent', Unset] = unset,
...
class WatchEventSources(api_client.Api):
