...
# body param
SchemaForRequestBodyApplicationJson = EventsourceUpdateEventSourceRequest
...
_path = '/api/v1/event-sources/{namespace}/{name}'
_method = 'PUT'
_auth = [
    'BearerToken',
]
SchemaFor200ResponseBodyApplicationJson = IoArgoprojEventsV1alpha1EventSource
...
class UpdateEventSource(api_client.Api):
