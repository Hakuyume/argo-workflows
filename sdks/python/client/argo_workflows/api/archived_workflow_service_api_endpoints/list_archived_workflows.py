...
_path = '/api/v1/archived-workflows'
_method = 'GET'
_auth = [
    'BearerToken',
]
SchemaFor200ResponseBodyApplicationJson = IoArgoprojWorkflowV1alpha1WorkflowList
...
class ListArchivedWorkflows(api_client.Api):
