...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1WorkflowRetryRequest
...
_path = '/api/v1/workflows/{namespace}/{name}/retry'
_method = 'PUT'
_auth = [
    'BearerToken',
]
...
class RetryWorkflow(api_client.Api):
