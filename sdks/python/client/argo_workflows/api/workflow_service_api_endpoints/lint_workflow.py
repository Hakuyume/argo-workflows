...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1WorkflowLintRequest
...
_path = '/api/v1/workflows/{namespace}/lint'
_method = 'POST'
_auth = [
    'BearerToken',
]
...
class LintWorkflow(api_client.Api):
