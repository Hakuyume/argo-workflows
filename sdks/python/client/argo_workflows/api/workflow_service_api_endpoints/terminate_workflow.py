...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1WorkflowTerminateRequest
...
_path = '/api/v1/workflows/{namespace}/{name}/terminate'
_method = 'PUT'
_auth = [
    'BearerToken',
]
...
class TerminateWorkflow(api_client.Api):
