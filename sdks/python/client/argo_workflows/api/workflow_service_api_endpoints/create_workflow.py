...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1WorkflowCreateRequest
...
_path = '/api/v1/workflows/{namespace}'
_method = 'POST'
_auth = [
    'BearerToken',
]
...
class CreateWorkflow(api_client.Api):
