...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1WorkflowResubmitRequest
...
_path = '/api/v1/workflows/{namespace}/{name}/resubmit'
_method = 'PUT'
_auth = [
    'BearerToken',
]
...
class ResubmitWorkflow(api_client.Api):
