...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1WorkflowStopRequest
...
_path = '/api/v1/workflows/{namespace}/{name}/stop'
_method = 'PUT'
_auth = [
    'BearerToken',
]
...
class StopWorkflow(api_client.Api):
