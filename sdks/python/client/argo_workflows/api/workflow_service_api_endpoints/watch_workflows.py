...
_path = '/api/v1/workflow-events/{namespace}'
_method = 'GET'
_auth = [
    'BearerToken',
]
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    @classmethod
    @property
    def result(cls) -> typing.Type['IoArgoprojWorkflowV1alpha1WorkflowWatchEvent']:
        return IoArgoprojWorkflowV1alpha1WorkflowWatchEvent
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        result: typing.Union['IoArgoprojWorkflowV1alpha1WorkflowWatchEvent', Unset] = unset,
...
class WatchWorkflows(api_client.Api):
