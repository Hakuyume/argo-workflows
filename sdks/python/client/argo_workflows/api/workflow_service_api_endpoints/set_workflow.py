...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1WorkflowSetRequest
...
_path = '/api/v1/workflows/{namespace}/{name}/set'
_method = 'PUT'
_auth = [
    'BearerToken',
]
...
class SetWorkflow(api_client.Api):
