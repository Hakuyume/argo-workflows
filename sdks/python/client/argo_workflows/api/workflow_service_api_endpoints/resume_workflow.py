...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1WorkflowResumeRequest
...
_path = '/api/v1/workflows/{namespace}/{name}/resume'
_method = 'PUT'
_auth = [
    'BearerToken',
]
...
class ResumeWorkflow(api_client.Api):
