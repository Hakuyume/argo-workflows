...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1WorkflowSuspendRequest
...
_path = '/api/v1/workflows/{namespace}/{name}/suspend'
_method = 'PUT'
_auth = [
    'BearerToken',
]
...
class SuspendWorkflow(api_client.Api):
