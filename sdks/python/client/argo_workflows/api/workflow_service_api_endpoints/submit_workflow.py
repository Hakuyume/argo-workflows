...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1WorkflowSubmitRequest
...
_path = '/api/v1/workflows/{namespace}/submit'
_method = 'POST'
_auth = [
    'BearerToken',
]
...
class SubmitWorkflow(api_client.Api):
