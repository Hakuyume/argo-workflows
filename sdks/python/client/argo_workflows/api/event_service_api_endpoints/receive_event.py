...
request_path_discriminator = api_client.PathParameter(
    name="discriminator",
...
_path = '/api/v1/events/{namespace}/{discriminator}'
_method = 'POST'
_auth = [
    'BearerToken',
]
...
class ReceiveEvent(api_client.Api):
