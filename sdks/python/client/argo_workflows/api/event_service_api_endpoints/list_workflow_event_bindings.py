...
_path = '/api/v1/workflow-event-bindings/{namespace}'
_method = 'GET'
_auth = [
    'BearerToken',
]
SchemaFor200ResponseBodyApplicationJson = IoArgoprojWorkflowV1alpha1WorkflowEventBindingList
...
class ListWorkflowEventBindings(api_client.Api):
