...
_path = '/api/v1/pipelines/{namespace}'
_method = 'GET'
_auth = [
    'BearerToken',
]
SchemaFor200ResponseBodyApplicationJson = GithubComArgoprojLabsArgoDataflowApiV1alpha1PipelineList
...
class ListPipelines(api_client.Api):
