...
_path = '/api/v1/stream/pipelines/{namespace}'
_method = 'GET'
_auth = [
    'BearerToken',
]
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    @classmethod
    @property
    def result(cls) -> typing.Type['PipelinePipelineWatchEvent']:
        return PipelinePipelineWatchEvent
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        result: typing.Union['PipelinePipelineWatchEvent', Unset] = unset,
...
class WatchPipelines(api_client.Api):
