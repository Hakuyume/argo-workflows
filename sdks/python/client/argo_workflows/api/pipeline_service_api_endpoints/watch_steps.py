...
_path = '/api/v1/stream/steps/{namespace}'
_method = 'GET'
_auth = [
    'BearerToken',
]
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    @classmethod
    @property
    def result(cls) -> typing.Type['PipelineStepWatchEvent']:
        return PipelineStepWatchEvent
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        result: typing.Union['PipelineStepWatchEvent', Unset] = unset,
...
class WatchSteps(api_client.Api):
