...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateLintRequest
...
_path = '/api/v1/cluster-workflow-templates/lint'
_method = 'POST'
_auth = [
    'BearerToken',
]
...
class LintClusterWorkflowTemplate(api_client.Api):
