...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateCreateRequest
...
_path = '/api/v1/cluster-workflow-templates'
_method = 'POST'
_auth = [
    'BearerToken',
]
...
class CreateClusterWorkflowTemplate(api_client.Api):
