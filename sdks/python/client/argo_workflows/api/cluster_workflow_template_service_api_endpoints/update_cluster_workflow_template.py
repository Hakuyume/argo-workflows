...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateUpdateRequest
...
SchemaFor200ResponseBodyApplicationJson = IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate
...
class UpdateClusterWorkflowTemplate(api_client.Api):
