...
_path = '/api/v1/stream/sensors/{namespace}'
_method = 'GET'
_auth = [
    'BearerToken',
]
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    @classmethod
    @property
    def result(cls) -> typing.Type['SensorSensorWatchEvent']:
        return SensorSensorWatchEvent
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        result: typing.Union['SensorSensorWatchEvent', Unset] = unset,
...
class WatchSensors(api_client.Api):
