...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1CreateCronWorkflowRequest
...
_path = '/api/v1/cron-workflows/{namespace}'
_method = 'POST'
_auth = [
    'BearerToken',
]
...
class CreateCronWorkflow(api_client.Api):
