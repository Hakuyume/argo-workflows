...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1CronWorkflowResumeRequest
...
_path = '/api/v1/cron-workflows/{namespace}/{name}/resume'
_method = 'PUT'
_auth = [
    'BearerToken',
]
...
class ResumeCronWorkflow(api_client.Api):
