...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1LintCronWorkflowRequest
...
_path = '/api/v1/cron-workflows/{namespace}/lint'
_method = 'POST'
_auth = [
    'BearerToken',
]
...
class LintCronWorkflow(api_client.Api):
