...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1CronWorkflowSuspendRequest
...
_path = '/api/v1/cron-workflows/{namespace}/{name}/suspend'
_method = 'PUT'
_auth = [
    'BearerToken',
]
SchemaFor200ResponseBodyApplicationJson = IoArgoprojWorkflowV1alpha1CronWorkflow
...
class SuspendCronWorkflow(api_client.Api):
