...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1WorkflowTemplateUpdateRequest
...
_path = '/api/v1/workflow-templates/{namespace}/{name}'
_method = 'PUT'
_auth = [
    'BearerToken',
]
SchemaFor200ResponseBodyApplicationJson = IoArgoprojWorkflowV1alpha1WorkflowTemplate
...
class UpdateWorkflowTemplate(api_client.Api):
