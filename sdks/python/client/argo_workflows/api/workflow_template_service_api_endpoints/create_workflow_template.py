...
# body param
SchemaForRequestBodyApplicationJson = IoArgoprojWorkflowV1alpha1WorkflowTemplateCreateRequest
...
_path = '/api/v1/workflow-templates/{namespace}'
_method = 'POST'
_auth = [
    'BearerToken',
]
...
class CreateWorkflowTemplate(api_client.Api):
